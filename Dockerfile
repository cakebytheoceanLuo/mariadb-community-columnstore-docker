...
# Install other stuff
RUN dnf -y install git htop policycoreutils-python zsh mariadb-gssapi-server
# https://mariadb.com/kb/en/authentication-plugin-gssapi/#installing-with-yumdnf